package com.dankicode.escape.level;
...
import com.dankicode.escape.level.block.*;
...
public abstract class Level {
	...
	protected Block getBlock(int x, int y, int col) {
		...
		if(col == 0x4CFF00) return new AppleBlock();
		return new Block();
	}
	...
	private static Level byName(String name) {
		try {
			...
			return (Level) Class.forName("com.dankicode.escape.level." + name + "Level").newInstance();
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
